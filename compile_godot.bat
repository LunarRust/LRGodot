...
call scons/scons.bat platform=windows target=template_debug d3d12=yes module_mono_enabled=yes debug_symbols=yes num_jobs=12 profiler=tracy profiler_path="%USERPROFILE%\godot\tracy" &&^
