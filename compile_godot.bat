scons/scons.bat platform=windows target=editor module_mono_enabled=yes module_godot_tracy_enabled=true module_godot_tracy_enabled=true profiler=tracy profiler_path="C:\Users\je0976317\Godot\Tools\tracy"
REM # Build export templates
scons/scons.bat platform=windows target=template_debug module_mono_enabled=yes module_godot_tracy_enabled=true profiler=tracy profiler_path="C:\Users\je0976317\Godot\Tools\tracy"
