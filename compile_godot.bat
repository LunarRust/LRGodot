...
call scons/scons.bat platform=windows target=template_debug d3d12=yes module_mono_enabled=yes debug_symbols=yes num_jobs=12 profiler=tracy profiler_path="C:\Users\je0976317\godot\tracy" &&^
...
call python .\modules\mono\build_scripts\build_assemblies.py --godot-output-dir .\bin --push-nupkgs-local C:\Users\je0976317\NuGet\lunarust_nuget\godot_nuget_store --godot-platform=windows